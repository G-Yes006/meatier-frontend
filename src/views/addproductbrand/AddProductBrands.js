    ...
    <>
      ...
      <CRow>
        <CCol xs="12" md="12">
          <CCard>
            <CCardHeader>
            Add the New Product Brands
             
            </CCardHeader>
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
               <CFormGroup row>
                  <CLabel col md={3}>Select the Product Brand  Image</CLabel>
                  <CCol xs="9" md="9">
                ...
                <CFormGroup row>
				 ...
				 <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Select Product Group</CLabel>
                  </CCol>
                  <CCol xs="9" md="9">
                    <CSelect custom name="select" id="select">
				  ...
				  <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="select">Enter Product Brand</CLabel>
                  </CCol>
                  <CCol xs="9" md="9">
